...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Assignment Solution - Also check Calculator.java
			Method sumMethod = myClass.getMethod("sum", double.class,double.class);
			System.out.println(sumMethod.invoke(myObj, 20.12,30.22));
